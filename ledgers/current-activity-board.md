...
| Assembly | governance | active | ninety-third ordinary sitting completed and ninety-fourth sitting opened | ninety-fourth ordinary sitting |
| Assembly Secretariat | governance | active | watch four active PJ and prepare the ninety-fourth packet | improvement board |
...
| Project Management Office | department | active | monitor four active PJ and support the ledger frontmatter draft path | assembly-secretariat |
...
| Engineering | department | active | run company-os development fixes in parallel with the governance loop and support the ledger frontmatter draft path | quality-assurance / internal-tools-enablement |
...
| Internal Tools and Enablement | department | active | prepare the ledger frontmatter draft as the first tooling execution focus | engineering / security-risk-compliance |
