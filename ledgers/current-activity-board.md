...
| Assembly | governance | active | seventeenth ordinary sitting completed and eighteenth sitting opened | eighteenth ordinary sitting |
| Assembly Secretariat | governance | active | rollout watch and eighteenth sitting packet | improvement board |
...
| People and Talent | department | active | keep the minimal `oem` seat motion ready for activation review deliberation | personnel-committee / PMO |
| Data and Knowledge | department | active | apply short ruling scope to ordinary operating decisions | assembly-secretariat |
| Security, Risk, and Compliance | department | active | keep the concrete `oem` low/medium risk path ready for activation review | release-review-committee |
...
| Project Management Office | department | active | carry the `oem` activation review path into deliberation | assembly-secretariat |
| Portfolio Strategy | department | active | monitor `oem` route adoption and keep `shift` as fallback | founder-office / PMO |
| Directorate | department | active | keep the `oem` reviewer nomination path ready for activation review | assembly |
