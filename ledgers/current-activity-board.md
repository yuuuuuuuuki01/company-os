...
| Assembly | governance | active | sixty-third ordinary sitting completed and sixty-fourth sitting opened | sixty-fourth ordinary sitting |
| Assembly Secretariat | governance | active | triple-active-lane watch and sixty-fourth sitting packet | improvement board |
...
| Exploration and Incubation | department | active | run bounded project origination and maintain the incubation slate and preparation ideas | portfolio-strategy / PMO |
...
| Project Management Office | department | active | monitor the first, second, and third active external lanes and support the `FormPilot` preparation-only path | assembly-secretariat |
| Portfolio Strategy | department | active | sequence the three active lanes and keep `FormPilot` as the next bounded candidate under preparation only | founder-office / PMO |
