...
| Assembly | governance | active | forty-eighth ordinary sitting completed and forty-ninth sitting opened | forty-ninth ordinary sitting |
| Assembly Secretariat | governance | active | dual-active-lane watch and forty-ninth sitting packet | improvement board |
...
| Project Management Office | department | active | monitor the first and second active external lanes and hold the bounded `jouzou` execution-threshold path | assembly-secretariat |
...
| Jouzou Unit | unit | ready | third candidate completed bounded activation-review path and waits for execution threshold only | people-talent / PMO |
