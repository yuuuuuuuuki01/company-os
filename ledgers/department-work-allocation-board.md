...
| assembly-secretariat | run the ordinary sitting loop and maintain rollout watch across active motions | eleventh sitting packet, meeting record updates, and committee handoff watch note | active | all active owners |
...
| portfolio-strategy | rank which non-company-os units should be activated first under the live gate model | onboarding priority board with first and fallback candidate | active | founder-office / PMO |
| project-management-office | rollout activation gate and confirm first external lane prerequisites | activation gate rollout note and first-candidate lane prerequisite check | active | assembly-secretariat / constitutional-review-committee |
...
| people-talent | reflect wave-1 steward confirmations and confirm first external seat prerequisites | officeholder confirmation note and first-candidate seat prerequisite check | active | personnel-committee |
