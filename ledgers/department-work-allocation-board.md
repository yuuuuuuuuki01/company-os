...
| assembly-secretariat | run the ordinary sitting loop and maintain rollout watch across active motions | fortieth sitting packet, meeting record updates, and dual-active-lane watch note | active | all active owners |
...
| portfolio-strategy | monitor the first and second active external routes and run the third-candidate readiness screen for `jouzou` | `oem` / `shift` sequencing note and `jouzou` readiness recommendation | active | founder-office / PMO |
| project-management-office | watch the active `oem` and `shift` lanes under the adopted control posture and supply the third-candidate screen inputs | dual-lane watch note and next candidate threshold package | active | assembly-secretariat / constitutional-review-committee |
