...
| assembly-secretariat | run the ordinary sitting loop and maintain rollout watch across active motions | fifteenth sitting packet, meeting record updates, and committee handoff watch note | active | all active owners |
...
| project-management-office | rollout activation gate and keep the first `oem` preparation packet deliberation-ready | activation gate rollout note and `oem` packet bundle | active | assembly-secretariat / constitutional-review-committee |
| directorate | review coherence of current operating artifacts and finalize a named `oem` reviewer route | quality note on active governance artifacts and `oem` reviewer proposal | active | assembly |
...
| security-risk-compliance | maintain key custody and keep a concrete `oem` preparation approval path ready | risk note for activation lanes and `oem` approval route | active | founder-office / release-review-committee |
| people-talent | reflect wave-1 steward confirmations and finalize a concrete first external seat route | officeholder confirmation note and `oem` seat-route draft | active | personnel-committee |
