...
| assembly-secretariat | run the ordinary sitting loop and rollout committee handoff pattern | next sitting packet, meeting record updates, and committee handoff rollout note | active | all active owners |
...
| people-talent | prepare the next steward and unit-owner seating wave | staffing slate for next seating wave | active | personnel-committee |
...
| data-knowledge | normalize records and maintain readable system memory | normalized priority records and live ledgers | active | assembly-secretariat |
