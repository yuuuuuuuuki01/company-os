...
| assembly-secretariat | run the ordinary sitting loop and maintain rollout watch across active motions | sixty-seventh sitting packet, meeting record updates, and triple-active-lane watch note | active | all active owners |
...
| portfolio-strategy | monitor the three active external routes and keep `FormPilot` as the next bounded candidate under activation review only | `oem` / `shift` / `jouzou` sequencing note and `FormPilot` activation-review recommendation | active | founder-office / PMO |
| project-management-office | watch the active `oem`, `shift`, and `jouzou` lanes under the adopted control posture and support the `FormPilot` activation-review path | triple-lane watch note and fourth-candidate activation-review package | active | assembly-secretariat / constitutional-review-committee |
...
| exploration-incubation | run the bounded project origination loop and produce incubation-ready briefs without opening lanes directly | project origination board, hypothesis slate, and FormPilot-adjacent brief refinement | active | portfolio-strategy / PMO |
