...
| assembly-secretariat | run the ordinary sitting loop and maintain rollout watch across active motions | twenty-second sitting packet, meeting record updates, and committee handoff watch note | active | all active owners |
...
| portfolio-strategy | monitor the first active external route and keep the fallback candidate ready | `oem` active / `shift` fallback monitoring note | active | founder-office / PMO |
| project-management-office | rollout activation gate and watch the first active `oem` lane | activation gate rollout note and first-lane watch note | active | assembly-secretariat / constitutional-review-committee |
| directorate | review coherence of current operating artifacts and watch the named `oem` reviewer route | quality note on active governance artifacts and `oem` reviewer watch note | active | assembly |
...
| security-risk-compliance | maintain key custody and watch the concrete `oem` active-lane approval path | risk note for activation lanes and `oem` approval watch | active | founder-office / release-review-committee |
| people-talent | reflect wave-1 steward confirmations and watch the first external seated unit-owner line | officeholder confirmation note and `oem` seat watch | active | personnel-committee |
