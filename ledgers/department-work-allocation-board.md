...
| assembly-secretariat | run the ordinary sitting loop and maintain rollout watch across active motions | eighteenth sitting packet, meeting record updates, and committee handoff watch note | active | all active owners |
...
| portfolio-strategy | monitor the first external onboarding route and keep the fallback candidate ready | `oem` first / `shift` fallback monitoring note | active | founder-office / PMO |
| project-management-office | rollout activation gate and carry the first `oem` activation review path | activation gate rollout note and `oem` activation review bundle | active | assembly-secretariat / constitutional-review-committee |
| directorate | review coherence of current operating artifacts and keep a named `oem` reviewer route ready | quality note on active governance artifacts and `oem` reviewer proposal | active | assembly |
...
| security-risk-compliance | maintain key custody and keep a concrete `oem` activation review approval path ready | risk note for activation lanes and `oem` approval route | active | founder-office / release-review-committee |
| people-talent | reflect wave-1 steward confirmations and keep a concrete first external seat route ready | officeholder confirmation note and `oem` seat-route draft | active | personnel-committee |
