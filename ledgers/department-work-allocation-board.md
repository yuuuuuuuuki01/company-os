...
| assembly-secretariat | run the ordinary sitting loop and maintain rollout watch across active motions | forty-ninth sitting packet, meeting record updates, and dual-active-lane watch note | active | all active owners |
...
| project-management-office | watch the active `oem` and `shift` lanes under the adopted control posture and hold the bounded `jouzou` execution-threshold path | dual-lane watch note and next candidate threshold package | active | assembly-secretariat / constitutional-review-committee |
