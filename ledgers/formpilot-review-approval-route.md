---
id: ledger-formpilot-review-approval-route
layer: ledger
status: active
...
# FormPilot Review And Approval Route

| Item | Proposed route | Owner | Status | Next handoff |
| --- | --- | --- | --- | --- |
| reviewer | Directorate nominates the initial `FormPilot` reviewer for outbound-sales automation MVP coherence checks | directorate | proposed | assembly-secretariat |
...
- this route is for preparation and initial internal changes only
