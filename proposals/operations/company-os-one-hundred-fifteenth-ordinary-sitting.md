...
Adopt the candidate-refill artifact for approval waits.
...
15. discussion-1: `承認待機中棚卸議案`
16. confirm the one-hundred-sixteenth ordinary sitting agenda

## Definition of done

- the next approval-wait operating artifact is opened
- refillable work can be tracked without blocking unrelated PJ progress
