---
id: company-os-one-hundred-thirtieth-ordinary-sitting
layer: proposal
status: motion-open
...
# Company OS One-Hundred-Thirtieth Ordinary Sitting

## 目的

承認待機の返却遅延エスカレーション成果物を `discussion-2` に進める。
...
21. discussion-2: `承認待機返却遅延エスカレーション議案`
22. 次回の one-hundred-thirty-first ordinary sitting 議題確認

## 完了条件

- 返却遅延エスカレーションの成果物が採択に十分な形まで絞られている
- 返却確認から遅延上申までの接続が短く保たれている
