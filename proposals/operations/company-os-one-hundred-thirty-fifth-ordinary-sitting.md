---
id: company-os-one-hundred-thirty-fifth-ordinary-sitting
layer: proposal
status: motion-open
...
# Company OS One-Hundred-Thirty-Fifth Ordinary Sitting

## 目的

承認待機の是正完了確認成果物を `discussion-1` に進める。
...
22. report: `承認待機返却遅延是正追跡議案`
23. discussion-1: `承認待機是正完了確認議案`
24. 次回の one-hundred-thirty-sixth ordinary sitting 議題確認

## 完了条件

- 是正完了確認の成果物が `discussion-2` に十分な形まで絞られている
- 遅延是正後に閉じられる条件が短く見える
