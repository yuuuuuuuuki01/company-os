---
id: company-os-one-hundred-thirty-first-ordinary-sitting
layer: proposal
status: motion-open
...
# Company OS One-Hundred-Thirty-First Ordinary Sitting

## 目的

承認待機の返却遅延エスカレーション成果物を採択し、次の是正追跡論点を開く。
...
21. deliberation: `承認待機返却遅延エスカレーション議案`
22. 次回の one-hundred-thirty-second ordinary sitting 議題確認

## 完了条件

- 返却遅延エスカレーションの成果物が採択されている
- 次の承認待機運用論点が開いている
