---
id: company-os-one-hundred-thirty-second-ordinary-sitting
layer: proposal
status: motion-open
...
# Company OS One-Hundred-Thirty-Second Ordinary Sitting

## 目的

承認待機の返却遅延是正追跡成果物を `discussion-1` に進める。
...
19. report: `承認待機借用記録議案`
20. report: `承認待機返却確認議案`
21. report: `承認待機返却遅延エスカレーション議案`
22. discussion-1: `承認待機返却遅延是正追跡議案`
23. 次回の one-hundred-thirty-third ordinary sitting 議題確認

## 完了条件

- 返却遅延是正追跡の成果物が `discussion-2` に十分な形まで絞られている
- 遅延上申後の追跡責任が短く見える状態になっている
