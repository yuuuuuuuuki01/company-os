---
id: company-os-one-hundred-thirty-third-ordinary-sitting
layer: proposal
status: motion-open
...
# Company OS One-Hundred-Thirty-Third Ordinary Sitting

## 目的

承認待機の返却遅延是正追跡成果物を `discussion-2` に進める。
...
22. discussion-2: `承認待機返却遅延是正追跡議案`
23. 次回の one-hundred-thirty-fourth ordinary sitting 議題確認

## 完了条件

- 返却遅延是正追跡の成果物が採択に十分な形まで絞られている
- 是正中と完了済みを短く区別できる
