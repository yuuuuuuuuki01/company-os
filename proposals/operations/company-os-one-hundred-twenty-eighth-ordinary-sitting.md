---
id: company-os-one-hundred-twenty-eighth-ordinary-sitting
layer: proposal
status: motion-open
...
# Company OS One-Hundred-Twenty-Eighth Ordinary Sitting

## 目的

承認待機の返却確認成果物を採択し、次の返却遅延エスカレーション論点を開く。
...
20. deliberation: `承認待機返却確認議案`
21. 次回の one-hundred-twenty-ninth ordinary sitting 議題確認
