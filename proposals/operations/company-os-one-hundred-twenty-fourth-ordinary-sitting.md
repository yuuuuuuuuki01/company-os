...
Advance the reservation-borrow log artifact for approval waits.
...
20. confirm the one-hundred-twenty-fifth ordinary sitting agenda

## Definition of done

- the reservation-borrow log artifact is narrowed enough for adoption
- reserved capacity can be traced and returned cleanly
