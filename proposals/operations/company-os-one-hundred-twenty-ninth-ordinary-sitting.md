---
id: company-os-one-hundred-twenty-ninth-ordinary-sitting
layer: proposal
status: motion-open
...
# Company OS One-Hundred-Twenty-Ninth Ordinary Sitting

## 目的

承認待機の返却遅延エスカレーション成果物を discussion-1 に進める。
...
21. discussion-1: `承認待機返却遅延エスカレーション議案`
22. 次回の one-hundred-thirtieth ordinary sitting 議題確認

## 完了条件

- 返却遅延エスカレーションの成果物が `discussion-2` に十分な形まで絞られている
- 返却確認の成果物が再利用可能な状態で維持されている
