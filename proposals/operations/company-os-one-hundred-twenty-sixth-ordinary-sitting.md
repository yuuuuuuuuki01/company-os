---
id: company-os-one-hundred-twenty-sixth-ordinary-sitting
layer: proposal
status: motion-open
...
# Company OS One-Hundred-Twenty-Sixth Ordinary Sitting

## 目的

承認待機の返却確認成果物を discussion-2 に進める。
...
20. discussion-1: `承認待機返却確認議案`
21. 次回の one-hundred-twenty-seventh ordinary sitting 議題確認

## 完了条件

- 返却確認の成果物が `discussion-2` に十分な形まで絞られている
- 借用済みの予約枠を、予約判断を開き直さずに閉じられる
