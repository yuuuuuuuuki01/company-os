---
id: company-os-seventeenth-ordinary-sitting
layer: proposal
status: adopted
...
# Company OS Seventeenth Ordinary Sitting

## Goal

Run `discussion-2` for the first `oem` activation review path while keeping active watch visible.
...
9. discussion-2: `oem-activation-review-motion`
10. confirm the eighteenth ordinary sitting agenda

## Definition of done

- `oem` activation review path is narrowed enough for deliberation
- active rollout watch remains visible

## Result

- active rollout watch remained visible
- `oem-activation-review-motion` reached `discussion-2`
- the eighteenth ordinary sitting was opened
